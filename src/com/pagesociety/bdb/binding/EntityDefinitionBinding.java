...
public class EntityDefinitionBinding extends TupleBinding
{
	...
	public Object entryToObject(DatabaseEntry data)
	{
		...
		{
			FieldDefinition f = read_field_definition(ti);
	...
	public static void write_field_definition(FieldDefinition f,TupleOutput to)
	{
	...
	public static FieldDefinition read_field_definition(TupleInput ti)
	{
	...
	public static  void write_default_reference_value(FieldDefinition f,Object value,TupleOutput to)
	{
		if(f.isArray())
	...
	public static void write_default_reference_value(Object val,TupleOutput to)
	{
	...
	public static void write_default_reference_array_value(Object val,TupleOutput to)
	{
	...
	//value so we now to create a new one on insert. this seems like useful behavior.
	//you can give every user a default collection automagically for instance	
	public static Object read_default_reference_value(FieldDefinition f,TupleInput ti)
	{
		if(f.isArray())
	...
	public static Object read_default_reference_value(TupleInput ti)
	{
	...
	public static Object read_default_reference_array_value(TupleInput ti)
	{
