...
public class EntityDefinitionBindingV0 extends TupleBinding
{
	private static final Logger logger = Logger.getLogger(EntityDefinitionBindingV0.class);

	public EntityDefinitionBindingV0(){}
